...
public class CameraRecordFragment extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback{
            ...
            switch (view.getId()) {
                case R.id.btnRecord: {
                    if (mIsRecordingVideo) {
                        mButtonVideo.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.ic_btn_rec));
                        stopRecordingVideo();
                    } else {
                        mButtonVideo.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.ic_btn_stop));
                        startRecordingVideo();
                    }
                    break;
                }
