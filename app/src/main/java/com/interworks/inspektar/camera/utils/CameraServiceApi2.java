...
public class CameraServiceApi2<T extends Activity> implements CameraContract {
    ...
    public CameraServiceApi2(T activity) {
        mActivity = activity;
...
//                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
    ...
    private void configureTransform(int viewWidth, int viewHeight) {
        if (mActivity == null ||  null == mTextureView || null == mPreviewSize) {
            return;
